...
const file_tvix_build_protos_build_proto_rawDesc = "" +
	"\n" +
	"\x1dtvix/build/protos/build.proto\x12\rtvix.build.v1\x1a!tvix/castore/protos/castore.proto\"\xb9\x06\n" +
	"\fBuildRequest\x12-\n" +
	"\x06inputs\x18\x01 \x03(\v2\x15.tvix.castore.v1.NodeR\x06inputs\x12!\n" +
	...
	"\x10environment_vars\x18\a \x03(\v2\".tvix.build.v1.BuildRequest.EnvVarR\x0fenvironmentVars\x12N\n" +
	"\vconstraints\x18\b \x01(\v2,.tvix.build.v1.BuildRequest.BuildConstraintsR\vconstraints\x12U\n" +
	"\x10additional_files\x18\t \x03(\v2*.tvix.build.v1.BuildRequest.AdditionalFileR\x0fadditionalFiles\x12'\n" +
	...
	"\bcontents\x18\x02 \x01(\fR\bcontents\"\xf2\x01\n" +
	"\x05Build\x12@\n" +
	"\rbuild_request\x18\x01 \x01(\v2\x1b.tvix.build.v1.BuildRequestR\fbuildRequest\x12/\n" +
	"\aoutputs\x18\x02 \x03(\v2\x15.tvix.castore.v1.NodeR\aoutputs\x12K\n" +
	"\x0foutputs_needles\x18\x03 \x03(\v2\".tvix.build.v1.Build.OutputNeedlesR\x0eoutputsNeedles\x1a)\n" +
	"\rOutputNeedles\x12\x18\n" +
	"\aneedles\x18\x01 \x03(\x04R\aneedlesB$Z\"code.tvl.fyi/tvix/build-go;buildv1b\x06proto3"
