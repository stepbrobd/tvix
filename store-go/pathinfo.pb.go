...
const file_tvix_store_protos_pathinfo_proto_rawDesc = "" +
	"\n" +
	" tvix/store/protos/pathinfo.proto\x12\rtvix.store.v1\x1a!tvix/castore/protos/castore.proto\"\x87\x01\n" +
	"\bPathInfo\x12)\n" +
	"\x04node\x18\x01 \x01(\v2\x15.tvix.castore.v1.NodeR\x04node\x12\x1e\n" +
	"\n" +
	"references\x18\x02 \x03(\fR\n" +
	"references\x120\n" +
	"\anarinfo\x18\x03 \x01(\v2\x16.tvix.store.v1.NARInfoR\anarinfo\"7\n" +
	"\tStorePath\x12\x12\n" +
	...
	"\n" +
	"signatures\x18\x03 \x03(\v2 .tvix.store.v1.NARInfo.SignatureR\n" +
	"signatures\x12'\n" +
	"\x0freference_names\x18\x04 \x03(\tR\x0ereferenceNames\x122\n" +
	"\aderiver\x18\x05 \x01(\v2\x18.tvix.store.v1.StorePathR\aderiver\x12)\n" +
	"\x02ca\x18\x06 \x01(\v2\x19.tvix.store.v1.NARInfo.CAR\x02ca\x1a3\n" +
	"\tSignature\x12\x12\n" +
	...
	"\vFLAT_SHA512\x10\bB$Z\"code.tvl.fyi/tvix/store-go;storev1b\x06proto3"
