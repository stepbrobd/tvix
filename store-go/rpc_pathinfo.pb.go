...
const file_tvix_store_protos_rpc_pathinfo_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"nar_sha256\x18\x02 \x01(\fR\tnarSha2562\xa0\x02\n" +
	...
	"\fCalculateNAR\x12\x15.tvix.castore.v1.Node\x1a#.tvix.store.v1.CalculateNARResponse\x12E\n" +
	"\x04List\x12\".tvix.store.v1.ListPathInfoRequest\x1a\x17.tvix.store.v1.PathInfo0\x01B$Z\"code.tvl.fyi/tvix/store-go;storev1b\x06proto3"
