...
const file_tvix_castore_protos_rpc_blobstore_proto_rawDesc = "" +
	"\n" +
	...
	"\x06chunks\x18\x02 \x03(\v2+.tvix.castore.v1.StatBlobResponse.ChunkMetaR\x06chunks\x12\x10\n" +
	...
	"\x03Put\x12\x1a.tvix.castore.v1.BlobChunk\x1a .tvix.castore.v1.PutBlobResponse(\x01B(Z&code.tvl.fyi/tvix/castore-go;castorev1b\x06proto3"
