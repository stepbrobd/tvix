...
const file_tvix_castore_protos_rpc_directory_proto_rawDesc = "" +
	"\n" +
	...
	"\x03Put\x12\x1a.tvix.castore.v1.Directory\x1a%.tvix.castore.v1.PutDirectoryResponse(\x01B(Z&code.tvl.fyi/tvix/castore-go;castorev1b\x06proto3"
