...
const file_tvix_castore_protos_castore_proto_rawDesc = "" +
	"\n" +
	"!tvix/castore/protos/castore.proto\x12\x0ftvix.castore.v1\"\xb8\x01\n" +
	"\tDirectory\x12@\n" +
	"\vdirectories\x18\x01 \x03(\v2\x1e.tvix.castore.v1.DirectoryNodeR\vdirectories\x12/\n" +
	"\x05files\x18\x02 \x03(\v2\x19.tvix.castore.v1.FileNodeR\x05files\x128\n" +
	"\bsymlinks\x18\x03 \x03(\v2\x1c.tvix.castore.v1.SymlinkNodeR\bsymlinks\"O\n" +
	...
	"\x04name\x18\x01 \x01(\fR\x04name\x12\x16\n" +
	"\x06target\x18\x02 \x01(\fR\x06target\"\xb9\x01\n" +
	"\x04Node\x12>\n" +
	"\tdirectory\x18\x01 \x01(\v2\x1e.tvix.castore.v1.DirectoryNodeH\x00R\tdirectory\x12/\n" +
	"\x04file\x18\x02 \x01(\v2\x19.tvix.castore.v1.FileNodeH\x00R\x04file\x128\n" +
	"\asymlink\x18\x03 \x01(\v2\x1c.tvix.castore.v1.SymlinkNodeH\x00R\asymlinkB\x06\n" +
	"\x04nodeB(Z&code.tvl.fyi/tvix/castore-go;castorev1b\x06proto3"
